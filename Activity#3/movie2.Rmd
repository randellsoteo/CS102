...
url_template <- 'https://www.imdb.com/title/tt0111161/reviews/_ajax?ref_=undefined&paginationKey=%s'
```
...
```{r}
# Save as CSV
write.csv(DataFrame, file = "2_imdb_reviews.csv", row.names = FALSE)
```
