...
url_template <- 'https://www.imdb.com/title/tt1375666/reviews/_ajax?ref_=undefined&paginationKey=%s'
```
...
```{r}
# Save as CSV
write.csv(DataFrame, file = "1_imdb_reviews.csv", row.names = FALSE)
```
